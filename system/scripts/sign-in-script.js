...
async function sign_in() 
{
	try 
	{
		let url = 'https://wyvernsite.net/sebMurray/system/scripts/sign-in-script.php';

		let email = document.getElementById("email").value;

		let hashed_password = sha512(document.getElementById("password").value);

		let form_data = new FormData();

		let alert_element = document.getElementById("invalid_input");

		form_data.append("member_email", email);
		form_data.append("hashed_member_password", hashed_password);
		...
		{
			window.location.replace("https://wyvernsite.net/sebMurray/system/home.php");
		}
	}
	catch (error) 
	{
